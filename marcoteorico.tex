...
\noindent lo que significa una reducción cercana al $20\%$. En la Figura~\ref{fig:fixVarTrees} se ilustran los árboles de las codificaciones de la Figura~\ref{fig:fixedVarLength}, en (a) el correspondiente a código de largo fijo, y en (b) el de largo variable. 
